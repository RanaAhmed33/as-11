        ...
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-[#042b80]">
          ...
          >
            ...
            <div className="space-y-1 text-sm relative">
              ...
              <div className="flex justify-start text-xs text-white">
            ...
            <button
              ...
              className="block w-full p-3 text-center rounded-sm  bg-violet-300 "
            >
              Sign in
            </button>
          </form>
          ...
          <p className="text-base text-center sm:px-6 text-white">
            If you new here?
            <Link className=" ml-2 btn-link text-orange-600" to="/register">
              Sign up
            </Link>
          </p>
        </div>
