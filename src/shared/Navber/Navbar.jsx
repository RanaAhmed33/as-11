      ...
      <div className="px-4 py-5 mx-auto max-w-7xl md:px-24 lg:px-8 ">
        <div className="relative flex items-center justify-between">
          ...
          >
            ...
            <p className="ml-2 text-3xl font-bold tracking-wide text-red-600 title-text">
              LEARN WITH TOYS
            </p>
          </Link>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase title-text">
                          <span className="text-red-600">LEARN WITH TOYS</span>
                        </span>
                      </Link>
                    </div>
                    <div>
                      ...
                      <li>
                        {user ? (
                          <>
                            ...
                            <button
                              onClick={handleLogout}
                              className="btn btn-outline btn-secondary mt-3 md:mt-0"
                            >
                              LOGOUT
                            </button>
                          </>
                          ...
                          <>
                            ...
                            <Link to="/login">
                              {" "}
                              <button className="btn btn-outline btn-primary mr-3 md:mr-0">
                                LOGIN
                              </button>
                            </Link>
                            <Link to="/register">
